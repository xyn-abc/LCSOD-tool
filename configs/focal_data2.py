...
from backend.models.backbones.focalnet import FocalNetBackbone
...
backbone = FocalNetBackbone("focalnet_large_lrf_fl4", weights=False, return_indices=(0, 1, 2, 3), freeze_indices=(0, 1))
