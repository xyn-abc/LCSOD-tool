...
from backend.models.backbones.resnet import ResNetBackbone
from backend.models.bricks.misc import FrozenBatchNorm2d
from backend.models.bricks.position_encoding import PositionEmbeddingSine
from backend.models.bricks.post_process import PostProcess
from backend.models.bricks.relation_transformer import (
    RelationTransformer,
...
from backend.models.bricks.set_criterion import HybridSetCriterion
from backend.models.detectors.relation_detr import backend
from backend.models.matcher.hungarian_matcher import HungarianMatcher
from backend.models.necks.channel_mapper import ChannelMapper
...
backbone = ResNetBackbone(
    "resnet50", norm_layer=FrozenBatchNorm2d, return_indices=(1, 2, 3), freeze_indices=(0, 1)
)
