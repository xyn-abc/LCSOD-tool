...
from backend.models.bricks.base_transformer import TwostageTransformer
from backend.models.bricks.basic import MLP
from backend.models.bricks.ms_deform_attn import MultiScaleDeformableAttention
from backend.models.bricks.position_encoding import get_sine_pos_embed
from backend.util.misc import inverse_sigmoid
...
class RelationTransformer(TwostageTransformer):
    ...
    def forward(
        ...
        outputs_classes, outputs_coords, object_queries = self.decoder(
            query=target,
            value=memory,
...
class RelationTransformerDecoder(nn.Module):
    ...
    def forward(
        ...
        object_queries = query_list[-1]
        return outputs_classes, outputs_coords, object_queries
