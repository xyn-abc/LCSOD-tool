...
from backend.util.collect_env import collect_env_info
from backend.util.logger import setup_logger
...
def default_setup(args, cfg, accelerator):
    ...
    list(map(lambda x: set_logger(name=x, output= '../../working/backend_Focal/log.log'), ["py.warnings", "accelerate", root_logger_name]))
