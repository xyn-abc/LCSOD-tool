...
from typing import Any, Callable, List, Mapping, Optional, Sequence, Tuple, Type, Union, TypeVar
...
class Datapoint(torch.Tensor):
    ...
    def _F(self) -> ModuleType:
        ...
        if Datapoint.__F is None:
            from backend.transforms.v2 import functional
    ...
    def __new__(
        ...
        *,
        ...
        if isinstance(data, PIL.Image.Image):
            from backend.transforms import functional as F
...
class Mask(Datapoint):
    ...
    def __new__(
        ...
        *,
        ...
        if isinstance(data, PIL.Image.Image):
            from backend.transforms.v2 import functional as F
