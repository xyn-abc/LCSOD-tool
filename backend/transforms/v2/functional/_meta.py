...
from backend.util.datapoints import BoundingBoxFormat
from backend.transforms import _functional_pil as _FP
from backend.transforms._functional_tensor import _max_value
