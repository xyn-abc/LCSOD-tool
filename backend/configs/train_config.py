...
from backend.transforms import presets
from backend.optimizer import param_dict
...
model_path = "config_train/relation_detr/relation_detr_resnet50_800_1333.py"
